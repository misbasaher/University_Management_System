...
public class AddStudent extends JFrame implements ActionListener {
    ...
    String rollNum = "24ETCS0020" + String.format("%01d", Math.abs(ran.nextInt() % 100));
   ...
   AddStudent(){
       ...
       lblrollno.setBounds(50,200,300,30);
       lblrollno.setFont(new Font("serif",Font.BOLD,20));
       add(lblrollno);
       
       labelrollno= new JLabel(rollNum);
       labelrollno.setBounds(200,200,300,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == submit){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null,"Student Details In serted Sucessfully");
                setVisible(false);
            }catch (Exception e){
                e.printStackTrace();
            }
