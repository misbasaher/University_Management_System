...
public class Marks extends JFrame implements ActionListener{
    ...
    Marks(String rollno){
        ...
        getContentPane().setBackground(new Color(150,160,170));
        
        JLabel heading = new JLabel("Ramaiah University Of Applied Scieces");
        heading.setBounds(100,10,500,25);
        heading.setFont(new Font("serif",Font.PLAIN, 20));
        add(heading);
        
        JLabel subheading = new JLabel("Result of examination2024.");
        ...
        try{
            Conn c = new Conn();
            ResultSet rs1= c.s.executeQuery("select * from subject1 where rollno = '"+rollno+"'");
            while(rs1.next()){
