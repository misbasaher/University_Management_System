...
public class EnterMarks extends JFrame implements ActionListener{
    ...
    EnterMarks() {
        ...
        getContentPane().setBackground(new Color(156,180,150));
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("exam1.jpeg"));
        ...
        String semester[] = {"1st Semester","2nd Semester","3rd Semester","4th Semester","4th Semester","5th Semester","6th Semester","7th Semester","8th Semester"};
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
           try{
               Conn c = new Conn();
               String query1 = "insert into subject1 values('"+crollno.getSelectedItem()+"','"+cbsemester.getSelectedItem()+"','"+tfsub1.getText()+"','"+tfsub2.getText()+"','"+tfsub3.getText()+"','"+tfsub4.getText()+"','"+tfsub5.getText()+"')";
